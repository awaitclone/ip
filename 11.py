...
class AutoShortenerMod(loader.Module):
    ...
    strings_ru = {
        ...
        "_cls_doc": (
            "Автоматически сокращает ссылки в твоих сообщениях, если они длиннее"" значения в конфиге"
        ),
        "on": "включен",
        "off": "выключен",
    }
    ...
    strings_de = {
        ...
        "_cls_doc": (
            "Kürzt automatisch URLs in Ihren Nachrichten, wenn sie länger sind als"" Wert in der Konfiguration"
        ),
        "on": "Aktiviert",
        "off": "Deaktiviert",
    }
    ...
    strings_tr = {
        ...
        "_cls_doc": (
            "URL'leri, yapılandırmanın değerinden daha uzun olduğunda mesajlarınızda"" otomatik olarak kısaltır"
        ),
        "on": "açık",
        "off": "kapalı",
    }
    ...
    strings_uz = {
        ...
        "_cls_doc": (
            "So'rovlarizdagi URL'ni konfiguratsiyadagi qiymatdan katta bo'lganda"" avtomatik ravishda qisqartadi"
        ),
        "on": "yoqilgan",
        "off": "o'chirilgan",
    }
